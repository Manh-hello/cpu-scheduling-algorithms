...
| Algorithm | Avg WT | Avg TAT | Avg RT | Context Switches | Starvation? |
|-----------|--------|---------|--------|------------------|-------------|
| FCFS      | 5.8    | 10.4    | 5.8    | 0                | No          |
| SJF       | 4.0    | 8.6     | 4.0    | 0                | Yes (P3)    |
| SRTF      | 3.8    | 8.4     | 2.8    | 5                | Yes (P3)    |
| RR (q=4)  | 6.4    | 11.0    | 4.2    | 6                | No          |
| Priority (NP) | 4.8 | 9.4    | 4.8    | 0                | Yes (P5)    |
| Priority (P)  | 4.6 | 9.2    | 3.6    | 4                | Yes (P5)    |

### Kt lun:

1. **Ti u Average WT**: SRTF (3.8) > SJF (4.0) > Priority-P (4.6)
2. **Ti u Response Time**: SRTF (2.8) > Priority-P (3.6) > RR (4.2)
3. **Cng bng nht**: RR v FCFS (khng c starvation)
4. **n gin nht**: FCFS (no preemption, no context switch)
5. **Thc t nht**: RR vi time quantum ph hp (balance gia fairness v performance)

### La chn thut ton:
- **Batch systems**: SJF/SRTF (optimize throughput)
- **Interactive systems**: RR (good response time, fairness)
- **Real-time systems**: Priority Scheduling with aging
- **General purpose OS**: Multilevel queue (kt hp nhiu thut ton)
